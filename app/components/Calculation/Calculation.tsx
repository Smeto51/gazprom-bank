  ...
  return (
    <div className="max-lg:pt-8 max-lg:pb-8 lg:mt-20  xl:max-w-[1280px] xl:pl-7 xl:pr-7 mx-auto">
      ...
      >
        ...
        {isOpenCalculation && (
          <div
            className="fixed w-3xl bottom-0 top-0 z-45 bg-white"
            style={{
        ...
        <div
          className={`
          fixed bottom-0 z-50 max-w-3xl
          bg-white rounded-t-2xl overflow-hidden flex flex-col max-h-[calc(100vh-80px)]
        ...
        >
          <>
            ...
            >
              ...
              <div className="border rounded-2xl flex mt-4 p-2 justify-center gap-4">
                {CALCULATION_ITEMS.map((item, index) => (
                  <div
                    key={item.id}
                    onClick={() => handleItemClick(index)}
                  ...
                  >
                    <p className="font-medium justify-center flex">
                      {item.title}
                    </p>
                  </div>
                ))}
          ...
          <div
            className="overflow-y-auto w-3xl overflow-x-hidden transition-all duration-500 ease-in-out"
            style={{

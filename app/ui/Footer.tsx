...
export const Footer = () => {
  ...
  return (
    <footer
      ...
      lg:mt-15 lg:pt-20 lg:pb-20  
    "
    >
      <div
        className="max-[1023px]:max-w-3xl w-full mx-auto px-4
      lg:pl-11 lg:pr-11 xl:pl-7 xl:pr-7 xl:max-w-7xl"
      >
        <div className="lg:flex lg:flex-nowrap lg:gap-6">
          <div className="lg:w-[296px] lg:grow lg:shrink lg:basis-[100%]">
            <div className="text-blue-500 lg:mb-8">
              <GazpromBankSvg />
            </div>
              ...
              ${
                showAll
                  ...
                  : "opacity-0 translate-y-2"
                      ...
                      style={{
                        transitionDelay: showAll ? `${i * 40}ms` : "0ms",
                      }}
                    >
                      <Link href={item.link}>
                        <span className="text-[16px] leading-5">
          ...
          <div className="lg:basis-[100%]">
            <div className="leading-5 text-[14px] text-black/50 space-y-2 flex flex-wrap lg:gap-3">
              {FOOTER_INFO.map((i) => (
            ...
            <div className="lg:mt-8">
              <p className="leading-5 text-[14px] text-black/50">
                ...
                персонализации сервисов и для повышения удобства работы с
                сайтом. Если вы не хотите, чтобы сookie хранились на вашем
                устройстве, вы можете запретить их в настройках браузера или с
                помощью специальных программ. Обратите внимание, что после их
                отключения сайт может работать хуже
              </p>
            </div>
            ...
            <p className="leading-5 text-[14px] text-black/50 lg:mt-8">
              © 1990-2025, Банк ГПБ (АО) Генеральная лицензия Банка России № 354
            </p>
            <div className="max-lg:mt-5 "></div>
          </div>
        </div>
      </div>
    </footer>
